...
2 - Migración de la db. La cual al correrla ya tendrá las tablas, estructuras y relaciones necesarias para el correcto funcionamiento de la plataforma.
3 - Endpoint con Registro de usuario
4 - Endpoint de Login con JWT
